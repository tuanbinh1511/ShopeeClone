...
import { fomatCurrency, formatNumberToSocial, rateSale } from 'src/utils/utils'
          ...
          <div className='grid grid-cols-12 gap-9 '>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button className='absolute left-0 top-1/2 z-10 mx-5 h-9 w-5 -translate-y-1/2 bg-black/20 text-white '>
                  <svg
                ...
                {product.images.slice(0, 5).map((img, index) => {
                  ...
                  return (
                    <div className='relative w-full pt-[100%] ' key={img}>
                      ...
                      />
                      {isActive && (
                        <div className='absolute top-0 left-0 h-[100%] w-[100%] border-[2px] border-orange'></div>
                      )}
                    </div>
                  )
                })}
                <button className='absolute right-0 top-1/2 z-10 mx-5 h-9 w-5 -translate-y-1/2 bg-black/20 text-white '>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
            ...
            <div className='col-span-7 '>
              ...
              <div className='relative mt-6 flex items-center '>
                <span className='mr-1 border-b-[2px] border-b-orange text-orange'>{product.rating}</span>
                <ProductRating
                  rating={product.rating}
                  activeClassname='fill-orange text-orange h-4 w-4 flex items-center'
                  noneActive='fill-gray-300 text-gray-300 h-4 w-4 flex items-center'
                />
